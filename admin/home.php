            ...
            <div id="page-inner">
				...
				<?php
						...
						while($row=mysqli_fetch_array($re) )
						{
								...
								$status = $row['status'];
								$id = $row['id'];
								if($new=="Not Confirm" && $status=="Paid")
								{
									$c = $c + 1;
								    ...
								    $status = $trow['status']; 
                                        ...
                                        <tbody>
                                            <tr>
												...
												<th><a href='roombook.php?rid=".$trow['id']." 'class='fa text-primary fa-eye fa-2x'></a></th>
												</tr>
                                                </tbody>";
										}else{
                                        //    echo "<div class='text-primary'>
                                        //    <h3>No New Booking Yet.... <i class='fa fa-eye-slash' aria-hidden='true'></i></h3> 
                                        //    </div>";
                                        }
