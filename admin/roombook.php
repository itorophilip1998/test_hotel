                            ...
                            <form method="post">
										<!-- <div class="form-group">
														...
														<select name="conf"class="form-control">
															...
															<option value="Confirm">Not Confirm</option>
...
<?php
						...
						{	
							...
							// if($st=="Confirm")
							// {
									$urb = "UPDATE `roombook` SET `stat`='Confirm' WHERE id = '$id'";
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) 
														VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";
